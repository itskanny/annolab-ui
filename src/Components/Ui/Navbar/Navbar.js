                ...
                <div className={'tw-flex'}>
                    {
                        auth.isLoggedIn?
                                ...
                                <div className={'an-header-icons tw-mr-6'}>
                                    {
                                        !auth.setup ?
                                            <>
                                                <Setting2 className={'tw-inline-block tw-mr-1  lg:tw-mr-3 mlg:tw-mr-6 tw-cursor-pointer'}/>
                                                <NotificationBing className={'tw-inline-block tw-mr-1 lg:tw-mr-3 mlg:tw-mr-6 tw-cursor-pointer'}/>
                                            </>
                            ...
                            :
                            <>
                                <Link to={'/signup'}><NavButton active={true} className={'tw-mr-5'}>SignUp</NavButton></Link>
