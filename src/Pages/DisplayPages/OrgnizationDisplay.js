...
const OrgnizationDisplay = (props) => {
        ...
        <>
            ...
            >
                <Col span={24} md={8} className={'tw-pr-3'}>
                    <Card >
                        <Meta title="Orgnization Name" description="This will be the orgnizations description that will contain all the details for the orgnization." />
                    </Card>
                </Col>
...
<h2>Current Projects</h2>
                    <Tooltip title={'Edit Projects'} key={'edit'}> <Button /*onClick={organizationEditHandler}*/ type="dashed"
